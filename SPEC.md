...
| Field | Value |
|---|---|
| Repository | `processing_microservice` |
...
Controlled execution of operating system processes. This document describes requirements, architecture, and acceptance criteria.
